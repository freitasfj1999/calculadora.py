...
✅ Funcionalidades Solicita o nome do usuário ao iniciar.
...
▶️ Como usar Certifique-se de ter o Python 3 instalado.

Clone o repositório ou copie o código para um arquivo chamado calculadora.py.

Execute o código no terminal: python calculadora.py
...
✍️ Autor João Vitor Ferreira Freitas"
